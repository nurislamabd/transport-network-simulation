...
The web simulation is deployed and running on Render:

**<https://transport-network-simulation.onrender.com/>**

> Hosted on a free Render instance, so the first request after a period of inactivity may take a few seconds to wake the service.
